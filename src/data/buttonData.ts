...
export const buttonData = [
  ...
  {
    text: "NEXT-GEN RAY TRACING",
    buttonContainerAlt: "image2",
    ButtonContainerSrc: "image2",
    imageClassName: "bg-cover md:w-auto",
    description:
  ...
  {
    text: "AI-POWERED GAMEPLAY",
    buttonContainerAlt: "image3",
    ButtonContainerSrc: "image3",
    imageClassName: "bg-cover md:w-auto",
    description:
  ...
  {
    text: "DUALSENSE 2 CONTROL",
    buttonContainerAlt: "image4",
    ButtonContainerSrc: "image4",
    imageClassName: "bg-cover md:w-auto",
    description:
  ...
  {
    text: "SSD 3.0 SPEED",
    buttonContainerAlt: "image5",
    ButtonContainerSrc: "image5",
    imageClassName: "bg-cover md:w-auto",
    description:
